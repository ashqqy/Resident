...
Resident_int_8 proc
    ...
    mov si, sp
    add si, (N_PUSHED_REGS - 2) * 2d    ; 9 regs * 2 bytes
    push ss:[si]                        ; push ip reg
    add si, 2
    push ss:[si]                        ; push cs reg
    sub si, 2 + 1                       ; + 1 because of correct regs parsing
    ...
    add sp, 4                           ; dont pop cs and ip regs
